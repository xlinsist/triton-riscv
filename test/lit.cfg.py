...
config.triton_shared_sanitizer_lib_dir = os.path.join(
    config.triton_shared_obj_root, "lib/Sanitizer/SanitizerAttributes"
)
...
config.triton_tools_dir = os.path.join(
    config.triton_shared_obj_root, "tools/triton-shared-opt"
)
